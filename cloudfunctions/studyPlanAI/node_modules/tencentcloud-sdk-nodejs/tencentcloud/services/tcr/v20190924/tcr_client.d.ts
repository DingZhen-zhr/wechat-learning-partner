...
注意：当PolicyIndex和CidrBlock同时存在时，CidrBlock优先级更高
     ...
     * 删除实例同步规则
     */
    DeleteReplicationRule(req: DeleteReplicationRuleRequest, cb?: (error: string, rep: DeleteReplicationRuleResponse) => void): Promise<DeleteReplicationRuleResponse>;
    /**
     * 用于在个人版中删除tag
     */
     ...
     * TCR实例存储桶切换
     */
    ModifyInstanceStorage(req: ModifyInstanceStorageRequest, cb?: (error: string, rep: ModifyInstanceStorageResponse) => void): Promise<ModifyInstanceStorageResponse>;
    /**
     * 查询长期访问凭证信息
     */
     ...
     * 终止制品清理任务
     */
    TerminateGCJob(req: TerminateGCJobRequest, cb?: (error: string, rep: TerminateGCJobResponse) => void): Promise<TerminateGCJobResponse>;
    /**
     * 更新镜像不可变规则
     */
     ...
     * 获取实例同步规则列表
     */
    DescribeReplicationPolicies(req: DescribeReplicationPoliciesRequest, cb?: (error: string, rep: DescribeReplicationPoliciesResponse) => void): Promise<DescribeReplicationPoliciesResponse>;
    /**
